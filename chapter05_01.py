...
# print('제가 print한 것(.remove(10)) -', tl1)
# print('제가 print한 것(.remove(10)) -', tl2)
# print('제가 print한 것(.remove(10)) -', tl3)
...
# print('제가 print한 것([0].remove(100)) -', tl1)
# print('제가 print한 것([0].remove(100)) -', tl2)
# print('제가 print한 것([0].remove(100)) -', tl3)
...
print('EX4-5 -', tl1)
print('EX4-5 -', tl2) # 튜플 재할당(객체 새로 생성)
print('EX4-5 -', tl3)
print(id(tl1[2]))  #값이 바뀌었습니다.
...
print('EX5-1 -', id(basket1._products), id(basket2._products), id(basket3._products)) # 참조 reference 까지 복사해줌
...
print('EX 7-1 -', tt1 is tt3, id(tt1), id(tt3))
...
print('EX7-4 -', ss1 is ss1, ss1 == ss1, id(ss1), id(ss1))
